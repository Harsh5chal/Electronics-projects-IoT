...
const char* ssid = "harsh5";    //your wifi network
const char* password = "harsh5chal";     //your wifi pasword
...
String GAS_ID = "AKfycbxT9e8DCFUFqrRdzDuq1RIAKikEvOfBmBBoMCDsPA8MQrgrbDF6";     //spreadsheet id
